                ...
                <div v-if="!isSignUp" class="w-full">
                    <div v-if="!showSignInForm" class="w-full space-y-4">
                        <button @click="showSignInForm = true"
                            class="btn btn-primary flex items-center justify-center w-full py-3">
                    ...
                    <form v-if="showSignInForm" class="w-full" @submit.prevent="handleSignIn">
                        <div class="p-2">
                            <div class="relative mb-10">
                                ...
                                <p v-if="signInErrors.identifier" class="mt-1 text-xs text-red-600">{{
                                    signInErrors.identifier }}</p>
                            </div>
                            ...
                            <div class="relative mb-10">
                                ...
                                <p v-if="signInErrors.password" class="mt-1 text-xs text-red-600">{{
                                    signInErrors.password }}</p>
                            </div>
                ...
                <form v-if="isSignUp" class="w-full" @submit.prevent="handleSignUp">
                    <div class="p-2">
                        ...
                        <div class="relative mb-10">
                            ...
                            <p v-if="signUpErrors.username" class="mt-1 text-xs text-red-600">{{ signUpErrors.username
                            }}</p>
                        </div>
                        ...
                        <div class="relative mb-10">
                            ...
                            <p v-if="signUpErrors.password" class="mt-1 text-xs text-red-600">{{ signUpErrors.password
                            }}</p>
                        </div>
                        ...
                        <div class="relative mb-10">
                            ...
                            <p v-if="signUpErrors.confirmPassword" class="mt-1 text-xs text-red-600">{{
